...
| `RATE_LIMIT_PER_MINUTE_NOTE` | `120` | Maximum allowed requests/minute per client (note info requests) |
...
Online notes are saved into `server/notes/`
